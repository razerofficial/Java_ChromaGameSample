...
This repository is a Java console game sample app created in Eclipse.

Import an existing project to the workspace.

![image_8](images/image_8.png)

Enter the `ChromaGameSample` path to the repository.

![image_9](images/image_9.png)

From the ChromaSampleApp.java source, right-click and select `Run As`->`Java Application`.
...
```
libs\CChromaEditorLibrary.dll
```

**64-bit libraries**

```
libs\CChromaEditorLibrary64.dll
```
