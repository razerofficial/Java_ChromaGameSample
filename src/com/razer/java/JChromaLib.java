...
interface JChromaLib extends Library {
	...
	*/
	...
	int PluginAddColor(final int color1, final int color2);
	/*
	...
	*/
	...
	void PluginAddNonZeroAllKeys(int sourceAnimationId, int targetAnimationId, int frameId);
	/*
	...
	*/
	...
	void PluginAddNonZeroAllKeysName(String sourceAnimation, String targetAnimation, int frameId);
	/*
	...
	*/
	...
	void PluginCopyAllKeys(int sourceAnimationId, int targetAnimationId, int frameId);
	/*
	Copy source animation to target animation for the given frame. Source and 
	target are referenced by id.
	*/
	/// EXPORT_API void PluginCopyAllKeysName(const char* sourceAnimation, const char* targetAnimation, int frameId);
	void PluginCopyAllKeysName(String sourceAnimation, String targetAnimation, int frameId);
	/*
	...
	*/
	...
	void PluginCopyZeroAllKeys(int sourceAnimationId, int targetAnimationId, int frameId);
	/*
	...
	*/
	...
	void PluginCopyZeroAllKeysName(String sourceAnimation, String targetAnimation, int frameId);
	/*
	Copy zero colors from source animation to target animation for the frame 
	...
	*/
	...
	void PluginCopyZeroAllKeysOffset(int sourceAnimationId, int targetAnimationId, int frameId, int offset);
	/*
	Copy zero colors from source animation to target animation for the frame 
	id starting at the target offset for the length of the source animation. 
	Source and target are referenced by name.
	*/
	...
	void PluginCopyZeroAllKeysOffsetName(String sourceAnimation, String targetAnimation, int frameId, int offset);
	/*
	...
	*/
	...
	void PluginCopyZeroTargetAllKeys(int sourceAnimationId, int targetAnimationId, int frameId);
	/*
	Copy nonzero color from source animation to target animation where target 
	...
	*/
	...
	void PluginCopyZeroTargetAllKeysName(String sourceAnimation, String targetAnimation, int frameId);
	/*
	...
	*/
	...
	int PluginCoreIsActive(Pointer active);
	/*
	Direct access to low level API.
	*/
	/// EXPORT_API RZRESULT PluginCoreIsConnected(ChromaSDK::DEVICE_INFO_TYPE& DeviceInfo);
	int PluginCoreIsConnected(DeviceInfos.DeviceInfosStruct DeviceInfo);
	/*
	Direct access to low level API.
	*/
	...
	*/
	...
	boolean PluginCoreStreamBroadcast(String streamId, String streamKey);
	/*
	...
	*/
	...
	boolean PluginCoreStreamBroadcastEnd();
	/*
	...
	*/
	...
	void PluginCoreStreamGetAuthShortcode(Pointer shortcode, Pointer length, final String platform, final String title);
	/*
	...
	*/
	...
	boolean PluginCoreStreamGetFocus(Pointer focus, Pointer length);
	/*
	...
	*/
	...
	void PluginCoreStreamGetId(String shortcode, Pointer streamId, Pointer length);
	/*
	...
	*/
	...
	void PluginCoreStreamGetKey(String shortcode, Pointer streamKey, Pointer length);
	/*
	...
	*/
	...
	String PluginCoreStreamGetStatusString(int status);
	/*
	...
	*/
	...
	boolean PluginCoreStreamReleaseShortcode(String shortcode);
	/*
	...
	*/
	...
	boolean PluginCoreStreamSetFocus(String focus);
	/*
	...
	*/
	...
	boolean PluginCoreStreamSupportsStreaming();
	/*
	...
	*/
	...
	boolean PluginCoreStreamWatch(String streamId, long timestamp);
	/*
	...
	*/
	...
	boolean PluginCoreStreamWatchEnd();
	/*
	Direct access to low level API.
	*/
	...
	*/
	...
	int PluginGetFrame(int animationId, int frameId, Pointer duration, Pointer colors, int length, Pointer keys, int keysLength);
	/*
	...
	*/
	...
	float PluginGetFrameDuration(int animationId, int frameId);
	/*
	Returns the duration of an animation frame in seconds upon success. Returns 
	zero upon failure.
	*/
	/// EXPORT_API float PluginGetFrameDurationName(const char* path, int frameId);
	float PluginGetFrameDurationName(String path, int frameId);
	/*
	Get the frame colors and duration (in seconds) for a `Chroma` animation 
	...
	*/
	...
	int PluginGetFrameName(String path, int frameId, Pointer duration, Pointer colors, int length, Pointer keys, int keysLength);
	/*
	...
	*/
	...
	float PluginGetTotalDuration(int animationId);
	/*
	Returns the total duration of an animation in seconds upon success. Returns 
	zero upon failure.
	*/
	/// EXPORT_API float PluginGetTotalDurationName(const char* path);
	float PluginGetTotalDurationName(String path);
	/*
	...
	*/
	...
	void PluginMultiplyTargetColorLerpName(String path, int frameId, int color1, int color2);
	/*
	...
	*/
	...
	int PluginSetCustomColorFlag2D(int device, Pointer colors);
	/*
	...
	*/
	...
	int PluginSetEffectCustom1D(final int device, Pointer colors);
	/*
	...
	*/
	...
	int PluginSetEffectCustom2D(final int device, Pointer colors);
	/*
	...
	*/
	...
	int PluginSetEffectKeyboardCustom2D(final int device, Pointer colors, Pointer keys);
	/*
	...
	*/
	...
	void PluginSetStaticColor(int deviceType, int device, int color);
	/*
	Sets all devices to the static color.
	*/
	/// EXPORT_API void PluginSetStaticColorAll(int color);
	void PluginSetStaticColorAll(int color);
	/*
	Sets the target device to the static color.
	*/
	...
	*/
	...
	void PluginStaticColorAll(int color);
	/*
	D suffix for limited data types.
	*/
	...
	*/
	...
	int PluginSubtractColor(final int color1, final int color2);
	/*
	...
	*/
	...
	void PluginSubtractNonZeroAllKeys(int sourceAnimationId, int targetAnimationId, int frameId);
	/*
	...
	*/
	...
	void PluginSubtractNonZeroAllKeysName(String sourceAnimation, String targetAnimation, int frameId);
	/*
	...
	*/
	...
	void PluginSubtractThresholdColorsMinMaxAllFramesRGB(final int animationId, final int minThreshold, final int minRed, final int minGreen, final int minBlue, final int maxThreshold, final int maxRed, final int maxGreen, final int maxBlue);
	/*
	Subtract all frames with the min RGB color where the animation color is 
	less than the min threshold AND with the max RGB color where the animation 
	is more than the max threshold. Animation is referenced by name.
	*/
	...
	void PluginSubtractThresholdColorsMinMaxAllFramesRGBName(String path, final int minThreshold, final int minRed, final int minGreen, final int minBlue, final int maxThreshold, final int maxRed, final int maxGreen, final int maxBlue);
	/*
	D suffix for limited data types.
	*/
	...
	double PluginSubtractThresholdColorsMinMaxAllFramesRGBNameD(String path, double minThreshold, double minRed, double minGreen, double minBlue, double maxThreshold, double maxRed, double maxGreen, double maxBlue);
	/*
	...
	*/
	...
	void PluginSubtractThresholdColorsMinMaxRGB(final int animationId, final int frameId, final int minThreshold, final int minRed, final int minGreen, final int minBlue, final int maxThreshold, final int maxRed, final int maxGreen, final int maxBlue);
	/*
	Subtract the specified frame with the min RGB color where the animation 
	color is less than the min threshold AND with the max RGB color where the 
	...
	*/
	...
	void PluginSubtractThresholdColorsMinMaxRGBName(String path, final int frameId, final int minThreshold, final int minRed, final int minGreen, final int minBlue, final int maxThreshold, final int maxRed, final int maxGreen, final int maxBlue);
	/*
	D suffix for limited data types.
	*/
	...
	double PluginSubtractThresholdColorsMinMaxRGBNameD(String path, final int frameId, final int minThreshold, final int minRed, final int minGreen, final int minBlue, final int maxThreshold, final int maxRed, final int maxGreen, final int maxBlue);
	/*
	...
	*/
	...
	void PluginUnloadLibraryStreamingPlugin();
	/*
	...
	*/
	...
	int PluginUpdateFrame(int animationId, int frameId, float duration, Pointer colors, int length, Pointer keys, int keysLength);
	/*
	...
	*/
	...
	int PluginUpdateFrameName(String path, int frameId, float duration, Pointer colors, int length, Pointer keys, int keysLength);
	/*
	...
	*/
	...
	void PluginUseForwardChromaEvents(boolean flag);
	/*
